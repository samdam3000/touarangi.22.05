...
def run_engine(): log_info(">>> run_engine() triggered at " + datetime.utcnow().isoformat())
...
def cron_loop(): while True: try: run_engine() except Exception as e: print("[CRON ERROR]", e) time.sleep(30)

if name == "main": cron_loop()
